...
-- // by some random on discord. fixed and added more stuff...
...
function Library.sections:Toggle(options)
    ...
    function Toggle:Colorpicker(options)
        ...
        local WindowSat = NewInstance("ImageLabel", {
            ...
            BorderSizePixel = 0;
            Size = UDim2.new(1, 0, 1, 0);
            Image = "http://www.roblox.com/asset/?id=88370754059021";
        })
        ...
        local WindowVal = NewInstance("ImageLabel", {
            ...
            BorderSizePixel = 0;
            Size = UDim2.new(1, 0, 1, 0);
            Image = "http://www.roblox.com/asset/?id=82106545074047";
        })
        ...
        local HuePalette = NewInstance("ImageButton", {
            ...
            Image = "http://www.roblox.com/asset/?id=77443822344315";
        })
        ...
        local CheckersImage = NewInstance("ImageLabel", {
            ...
            BorderSizePixel = 0;
            Size = UDim2.new(1, 0, 1, 0);
            Image = "http://www.roblox.com/asset/?id=140497207943194";
